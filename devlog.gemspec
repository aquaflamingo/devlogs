...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Create, manage and sync developer logs"
  spec.description   = "Create, manage and sync developer logs"
  spec.homepage      = "http://github.com/aquaflamingo"
  spec.license       = "MIT"
  spec.required_ruby_version = Gem::Requirement.new(">= 2.3.0")

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/aquaflamingo"
  spec.metadata["changelog_uri"] = "https://github.com/aquaflamingou"
